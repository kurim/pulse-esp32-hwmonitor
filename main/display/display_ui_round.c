...
void build_round_ui(void)
{
    ...
    // Haupt-Widget transparent machen
    ...
    // Hintergrund-Spur (20% Deckkraft, Zyan)
    lv_obj_set_style_arc_color(round_arc_cpu, COL_ACCENT, LV_PART_MAIN);
    ...
    // Aktiver Indikator (100% Deckkraft, Zyan)
    lv_obj_set_style_arc_color(round_arc_cpu, COL_ACCENT, LV_PART_INDICATOR);
    lv_obj_set_style_arc_opa(round_arc_cpu, LV_OPA_COVER, LV_PART_INDICATOR);
    ...
    // Zentrierungs-Padding für den aktiven Bogen berechnen
    ...
    // Hintergrund-Spur (20% Deckkraft, Gelb)
    lv_obj_set_style_arc_color(round_arc_gpu, COL_GPU, LV_PART_MAIN);
    ...
    // Aktiver Indikator (100% Deckkraft, Gelb)
    lv_obj_set_style_arc_color(round_arc_gpu, COL_GPU, LV_PART_INDICATOR);
    lv_obj_set_style_arc_opa(round_arc_gpu, LV_OPA_COVER, LV_PART_INDICATOR);
    ...
    const lv_color_t wcolors[4] = { COL_THERMO, COL_RAIN, COL_SUB, COL_RAIN };
...
void refresh_round_ui(void)
{
    ...
    // Standby: Uhrzeit groesser + weiter oben
