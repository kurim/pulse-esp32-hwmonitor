...
static void ap_confirm_revert_cb(lv_timer_t *t)
{
    ...
    lv_obj_set_style_bg_color(w_set_ap_btn, COL_CARD, 0);
                       ...
                       bool is_gpu, lv_color_t bar_a, lv_color_t bar_b)
{
    ...
    lv_obj_t *t = make_label(card, title, &lv_font_montserrat_20, COL_TEXT);
    ...
    tile->temp_lbl  = make_label(row, "--C", &lv_font_montserrat_16, COL_SUB);
    tile->power_lbl = make_label(row, LV_SYMBOL_CHARGE " --W", &lv_font_montserrat_16, COL_SUB);
    tile->trend_lbl = make_label(row, "-", &lv_font_montserrat_16, COL_SUB);
    ...
    lv_obj_t *cap = make_label(card, ui_str(UI_STR_USAGE_CHART_CAPTION), &lv_font_montserrat_14, COL_SUB);
...
static void build_wide_main(void)
{
    ...
    lv_obj_set_style_bg_color(w_lbl_waiting, COL_BG, 0);
...
static void build_wide_settings(void)
{
    ...
    w_set_fw   = make_label(card, "", &lv_font_montserrat_14, COL_TEXT);
    lv_obj_set_pos(w_set_fw, 20, 62);
    w_set_ip   = make_label(card, "", &lv_font_montserrat_14, COL_TEXT);
    lv_obj_set_pos(w_set_ip, 20, 84);
    w_set_wifi = make_label(card, "", &lv_font_montserrat_14, COL_TEXT);
    lv_obj_set_pos(w_set_wifi, 20, 106);
    w_set_mqtt = make_label(card, "", &lv_font_montserrat_14, COL_TEXT);
    lv_obj_set_pos(w_set_mqtt, 20, 128);
    w_set_heap = make_label(card, "", &lv_font_montserrat_14, COL_SUB);
    lv_obj_set_pos(w_set_heap, 20, 150);

    lv_obj_t *hint = make_label(card, ui_str(UI_STR_SETTINGS_HINT), &lv_font_montserrat_14, COL_SUB);
    ...
    w_set_ap_btn_lbl = make_label(w_set_ap_btn, ui_str(UI_STR_AP_BTN_IDLE), &lv_font_montserrat_14, COL_TEXT);
...
static void build_wide_standby(void)
{
    ...
    w_standby_lbl_time = make_label(scr_standby, "--:--:--", &lv_font_montserrat_48, COL_TEXT);
    lv_obj_align(w_standby_lbl_time, LV_ALIGN_CENTER, 0, -40);

    w_standby_lbl_date = make_label(scr_standby, "", &lv_font_montserrat_20, COL_SUB);
    lv_obj_align(w_standby_lbl_date, LV_ALIGN_CENTER, 0, 30);

    w_standby_lbl_weather = make_label(scr_standby, "", &lv_font_montserrat_20, COL_SUB);
