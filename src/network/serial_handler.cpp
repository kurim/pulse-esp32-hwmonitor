...
void serial_handler_begin(void)
{
    ...
    //
    // Nur aktiv bei HW_SOURCE_USB: bei HW_SOURCE_MQTT nutzt
    // wifi_provision_begin() denselben Port fuer Improv-WiFi-Provisionierung.
    // Beide gleichzeitig lesend wuerden um dieselben Bytes konkurrieren.
    s_enabled = (app_config.hw_source == HW_SOURCE_USB);
}
